...
# Import architectures from your local file
# We try 'ensemble' first (as per the previous file structure), then 'evaluation'
...
class SearchEngine:
    ...
    def _load_ensemble(self):
        try:
            ...
            # Shared Metadata
            self.db_paths = ckpt_v1['db_paths']
